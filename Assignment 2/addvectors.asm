...
;           secondIntarray are added together using vector addition and the result is stored in thirdIntArray. Since
;           these arrays were passed by reference, there is no need to return anything to 'main' from this module.
;
; Allocation of registers:
;  
;   r11: used for vector addition
...
;
;
; Call the assembler:  nasm -f elf64 -o addvectors.o addvectors.asm
; 
;----------------------------------------------------------------------------------------------------------------------
extern printf, scanf
...
doAddition:
    ...
    add     r11, [r14 + 8 * r12]        ; Add secondIntArray[index] to r11
    mov     [r15 + 8 * r12], r11        ; Move the result from the addition into thirdIntArray[index]

    inc     r12                         ; Increment r12 (the indexer)
    ...
    jl      doAddition                  ; If index (r12) is less than that counter (total number of elements in the array)
